...
function App() {
  ...
  return (
    ...
    <div className="container bg-gray-100">
      ...
      <a href='https://www.instagram.com/biswajit_kdb/' target='_blank' rel='noreferrer' className='flex gap-2 flex-row justify-center items-center'>
        ...
        <h1 className='text-xl text-black font-semibold font-mono'>Made by biswajit_kdb</h1>
      </a>
